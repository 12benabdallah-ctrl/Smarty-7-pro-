    ...
    <aside className={`relative z-30 bg-black/10 backdrop-blur-2xl border-r border-white/5 transition-all duration-700 flex flex-col ${isOpen ? 'w-80' : 'w-24'}`}>
      ...
      <div className="p-6 mt-auto">
        <motion.button 
          ...
          whileHover={{ scale: 1.02, backgroundColor: '#ff5e1a' }}
          whileTap={{ scale: 0.95 }}
          className="w-full p-5 rounded-[1.5rem] bg-[#ff4e00] text-white shadow-lg shadow-[#ff4e00]/20 transition-all flex items-center justify-center"
        >
